...
from .views import medicines, MedicineDetailView, search_medicine, PrescriptionDetailView, PrescriptionListView, \
    PrescribedByUserListView, PrescriptionUpdateView, PrescriptionCreateView, PrescriptionDeleteView, SideEffectCreateView, \
    SideEffectDetailView, SideEffectUpdateView, SideEffectDeleteView, MedicineCreateView, MedicineUpdateView, \
    MedicineDeteleView, main_page, CurrentOrdersListView, ArchivalOrdersListView, OrdersByStateListView, OrderDetailView
